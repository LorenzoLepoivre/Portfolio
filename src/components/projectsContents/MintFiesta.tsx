function MintFiesta() {
    return (
      <div>
        <p>This project was build during the ETH Brussels in July 2024.</p>
        <p>The project is a dApp that allows event organizers and their sponsors to reward and boost participant enthusiasm with exclusive NFTs.</p>
